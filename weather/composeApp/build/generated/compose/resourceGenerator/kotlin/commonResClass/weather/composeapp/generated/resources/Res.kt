...
package weather.composeapp.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/weather.composeapp.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/weather.composeapp.generated.resources/" + path)
